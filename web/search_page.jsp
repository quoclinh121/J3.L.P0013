<%-- 
    ...
    Created on : Jan 10, 2021, 3:26:42 PM
    Author     : quocl
--%>
...
<html>
    ...
    <body>
        ...
        <div style="float: right; margin-top: 10px; margin-right: 10px">
            <form action="MainController" method="POST">
                <input type="submit" class="btn btn-outline-primary" value="Shopping History" name="btnAction"/>
            </form>
        </div> 
        <div style="float: right; margin-top: 10px; margin-right: 10px">
            <form action="MainController" method="POST">
                <input type="submit" class="btn btn-outline-primary" value="View cart" name="btnAction"/>
            </form>
        </div> <br/> <br/>
                ...
                <tbody>
                    ...
                    <form action="MainController" method="POST">
                        <tr>
                            ...
                            <td>
                                <input type="hidden" name="addItemToCart" value="${dto.getItemID()}" />
                                <input type="hidden" name="page" value="${requestScope.CURRENT_PAGE}" />
                                <input type="submit" class="btn btn-outline-success" value="Add to cart" name="btnAction"/>
                            </td>
                        </tr>
                    </form>
                </c:forEach>
