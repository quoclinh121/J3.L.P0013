 ...
 * @author quocl
 */
@WebServlet(name = "DescreaseQuantityServet", urlPatterns = {"/DescreaseQuantityServet"})
public class DescreaseQuantityServet extends HttpServlet {

    private static final Logger LOGGER = Logger.getLogger(DescreaseQuantityServet.class);
